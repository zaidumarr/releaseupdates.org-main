...
const TRANSLATIONS = {
  en: {
    ...
    latestUpdatesAction: 'Latest Updates',
    updatedLabel: 'Updated',
    latest24hTitle: 'Latest from last 24 hours',
    releaseArchive: 'Release archive',
    archiveHelper: 'Older releases stay below so you never lose context.',
    noUpdatesFound: 'No updates in the last 24 hours. See archive below.',
    close: 'Close',
  ...
  ru: {
    ...
    latestUpdatesAction: 'Последние обновления',
    updatedLabel: 'Обновлено',
    latest24hTitle: 'Обновления за последние 24 часа',
    releaseArchive: 'Архив релизов',
    archiveHelper: 'Старые релизы остаются ниже — контекст не теряется.',
    noUpdatesFound: 'Нет обновлений за последние 24 часа. Смотрите архив ниже.',
    close: 'Закрыть',
  ...
  it: {
    ...
    latestUpdatesAction: 'Ultimi aggiornamenti',
    updatedLabel: 'Aggiornato',
    latest24hTitle: 'Ultime 24 ore',
    releaseArchive: 'Archivio rilasci',
    archiveHelper: 'I rilasci precedenti restano sotto per avere contesto.',
    noUpdatesFound: 'Nessun aggiornamento nelle ultime 24 ore. Guarda l’archivio sotto.',
    close: 'Chiudi',
  ...
  fr: {
    ...
    latestUpdatesAction: 'Dernières mises à jour',
    updatedLabel: 'Mis à jour',
    latest24hTitle: 'Dernières 24h',
    releaseArchive: 'Archive des versions',
    archiveHelper: 'Les versions précédentes restent listées pour garder le contexte.',
    noUpdatesFound: 'Aucune mise à jour dans les dernières 24h. Voir l’archive ci-dessous.',
    close: 'Fermer',
  ...
  es: {
    ...
    latestUpdatesAction: 'Últimas actualizaciones',
    updatedLabel: 'Actualizado',
    latest24hTitle: 'Últimas 24h',
    releaseArchive: 'Archivo de versiones',
    archiveHelper: 'Las versiones anteriores quedan abajo para mantener el contexto.',
    noUpdatesFound: 'No hay actualizaciones en las últimas 24 horas. Consulta el archivo abajo.',
    close: 'Cerrar',
  ...
  pt: {
    ...
    latestUpdatesAction: 'Últimas atualizações',
    updatedLabel: 'Atualizado',
    latest24hTitle: 'Últimas 24h',
    releaseArchive: 'Arquivo de versões',
    archiveHelper: 'Versões anteriores ficam abaixo para manter o contexto.',
    noUpdatesFound: 'Nenhuma atualização nas últimas 24 horas. Veja o arquivo abaixo.',
    close: 'Fechar',
  ...
  zh: {
    ...
    latestUpdates: '最新更新',
    latestUpdatesAction: '最新更新',
    updatedLabel: '已更新',
    latest24hTitle: '过去 24 小时更新',
    releaseArchive: '历史版本',
    archiveHelper: '旧版本会保留在下面，方便查看历史。',
    noUpdatesFound: '过去 24 小时无更新，可查看下方历史列表。',
    close: '关闭',
    visitWebsite: '访问网站',
    officialNotes: '官方说明',
  },
  ja: {
    ...
    latestUpdates: '最新の更新',
    latestUpdatesAction: '最新の更新',
    updatedLabel: '更新',
    latest24hTitle: '直近24時間',
    releaseArchive: 'リリースアーカイブ',
    archiveHelper: '過去のリリースも下に残してコンテキストを維持します。',
    noUpdatesFound: '直近24時間に更新はありません。下のアーカイブを参照してください。',
    close: '閉じる',
    visitWebsite: '公式サイト',
    officialNotes: '公式ノート',
  },
